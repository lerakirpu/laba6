...
int main(){
    ...
    Matrix m;
    m.print();
    std::cout<<"\nМатрица 2 с рандомными значениями:\n";

    Matrix m2(4,4);
    m2.print();
    std::cout<<"\nМатрица 3 с рандомными значениями:\n";

    Matrix m3(4,4);
    m3.print();
    std::cout<<"\nСумма Матрицы 2 с Матрицей 3 с рандомными значениями:\n";

    Matrix Z = m2+m3;
    Z.print();
    std::cout<<"\nРазность Матрицы 2 с Матрицей 3 с рандомными значениями:\n";
